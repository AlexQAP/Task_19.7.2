...
def test_add_new_pet_with_valid_data(name='Барбоскин', animal_type='двортерьер',
                                     age='4', pet_photo='images/Gena.jpg'):
...
def test_successful_update_self_pet_info(name='Гена', animal_type='Аллигатор', age=56):
...
def test_successful_delete_self_pet():
        ...
        if len(my_pets['pets']) == 0:
            pf.add_new_pet(auth_key, "Суперкот", "кот", "3", "images/Gena.jpg")
            _, my_pets = pf.get_list_of_pets(auth_key, "my_pets")
...
# Доп. тест №1
def test_create_new_pet_simple(name='Геннадий', animal_type='Крокодил', age='37'):
...
# Доп. тест №2
def test_add_pet_photo(pet_photo='images/Gena.jpg'):
    ...
    if len(my_pets['pets']) == 0:
        pf.create_new_pet_simple(auth_key, 'Геннадий', 'Крокодил', '37')
        _, my_pets = pf.get_list_of_pets(auth_key, 'my_pets')
...
def test_create_new_pet_invalid_age_format(name='Геннадий', animal_type='Крокодил', age='Asd@#'):
...
def test_create_new_pet_invalid_name_format(name=12345, animal_type='Крокодил', age='37'):
...
def test_add_new_pet_with_same_data(name='Геннадий', animal_type='Крокодил', age='37', pet_photo='images/Gena.jpg'):
